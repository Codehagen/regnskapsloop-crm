          ...
          {services.map(({ name, description, icon: Icon }, index) => (
            <div
              ...
              className={cn(
                ...
                "lg:nth-[3n]:border-r-0 lg:nth-[n+4]:border-b-0 lg:border-r"
              )}
            >
              <div className="flex flex-col gap-y-2 items-center">
                <div className="bg-linear-to-b from-primary to-primary/80 p-2 rounded-lg text-white transition-colors group-hover:from-secondary group-hover:to-secondary/80">
                  {Icon}
                </div>
